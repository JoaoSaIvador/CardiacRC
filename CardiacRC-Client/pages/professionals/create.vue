...
<div >
  <Topbar/>
  <b-container>
    <h2 class="mb-3 text-center">Create Professional</h2>
    <form class="needs-validation" @submit.prevent="createProfessional" :disabled="!isFormValid">
      ...
      <div class="col-sm-4 offset-sm-4">
        ...
        <div class="col-sm-4 offset-sm-4">
            <b-form-group id="licenseNumber" label="License Number:" label-for="licenseNumber" :invalid-feedback="invalidLicensethNumberFeedback" :state="isLicenseNumberValid">
              <b-input id="licenseNumber" type="number" v-model.trim="licenseNumber" placeholder="Enter your license number" :state="isLicenseNumberValid" trim></b-input>
            </b-form-group>
        </div>
        ...
        <div class="col-sm-4 offset-sm-4">
          ...
          <button @click.prevent="createProfessional" class="btn btn-secondary" :disabled="!isFormValid">Create</button>
        </div>
    </form>
  </b-container>
</div>
...
<script>
  ...
  methods: {
    createProfessional() {
      this.$axios.$post('/api/professionals', {
