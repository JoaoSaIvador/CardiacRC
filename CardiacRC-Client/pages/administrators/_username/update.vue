...
<div >
  <Topbar/>
  <b-container>
    <h2 class="mb-3 text-center">Update Administrator</h2>
    <form class="needs-validation" @submit.prevent="updateAdministrator" :disabled="!isFormValid">
      ...
      <div class="col-sm-4 offset-sm-4">
        ...
        <div class="col-sm-4 offset-sm-4">
          ...
          <button @click.prevent="updateAdministrator" class="btn btn-secondary" :disabled="!isFormValid">Update</button>
        </div>
    </form>
  </b-container>
</div>
