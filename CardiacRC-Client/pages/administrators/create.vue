...
<div >
  ...
  <b-container>
    ...
    <form class="needs-validation" @submit.prevent="createAdministrator" :disabled="!isFormValid">
      ...
      <div class="col-sm-4 offset-sm-4">
        ...
        <div class="col-sm-4 offset-sm-4">
          ...
          <button @click.prevent="createAdministrator" class="btn btn-secondary" :disabled="!isFormValid">Create</button>
        </div>
    </form>
  </b-container>
</div>
